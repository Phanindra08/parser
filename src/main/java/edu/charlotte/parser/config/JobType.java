...
public enum JobType {
    ...
    REL_DL_TO_D_REAL_OUTPUT_CONVERSION(Constants.JOBNAME_DL_TO_D_REAL_OUTPUT_CONVERSION, Constants.SMT_EXTENSION),
    REL_DL_TWO_FILES_COMBINING(Constants.JOBNAME_REL_DL_TWO_FILES_COMBINING, Constants.REL_DL_TWO_FILE_COMBINING_EXTENSION);
